...
function Hero(){
    const [textmk] = useTypewriter({
       words : ["mern stack developer","ui/ ux designer", "Computer enginner"],
       loop : {},
       typeSpeed: 200,
       delaySpeed: 40
    });
